...
def test_find_terms_in_universe(client, find_term_param) -> None:
    ...
    select = True
    _test_get(client, url, params, find_term_param.item.term_id, select)
...
def test_find_data_descriptors(client, find_dd_param) -> None:
    ...
    select = False
    _test_get(client, url, params, find_dd_param.item.data_descriptor_id, select)
...
def test_find_collections_in_project(client, find_col_param) -> None:
    ...
    select = False
    _test_get(client, url, params, find_col_param.item.collection_id, select)
