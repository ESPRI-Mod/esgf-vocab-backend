...
@router.get(
    "/", summary="Get all project ids", description=generate_route_desc(f"{PROJECTS_PAGE_PREFIX}.get_all_projects")
)
...
async def get_all_terms_in_project(
    ...
    result = projects.get_all_terms_in_project(project_id=project_id, selected_term_fields=selected_term_fields)
    return check_result(result)


@router.get(
    "/{project_id}/terms/{term_id}",
...
async def get_term_in_project(
    ...
    result = projects.get_term_in_project(
        project_id=project_id, term_id=term_id, selected_term_fields=selected_term_fields
    )
    return check_result(result)
...
async def get_all_collections_in_project(
    project_id: Annotated[str, Path(description="an id of a project")],
) -> list[str]:
...
@router.get(
    "/{project_id}/collections/{collection_id}/terms",
...
async def get_all_terms_in_collection(
    ...
    result = projects.get_all_terms_in_collection(
        project_id=project_id, collection_id=collection_id, selected_term_fields=selected_term_fields
    )
    return check_result(result)


@router.get(
    "/{project_id}/collections/{collection_id}/terms/{term_id}",
...
async def get_term_in_collection(
    ...
    result = projects.get_term_in_collection(
